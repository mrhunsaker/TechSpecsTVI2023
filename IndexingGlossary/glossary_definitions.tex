...
\newglossaryentry{audio}{
	name={audio},
	type={modality},
	description={Acoustic output channel leveraged for speech, earcons, spatial cues, and sonification. Critical to non-visual workflows (e.g., \gls{screenreader} speech, \gls{spatial (binaural) audio}, \gls{informationalaudiocue}). See also: \gls{texttospeech}, \gls{sonification}, \gls{haptic}.}
}

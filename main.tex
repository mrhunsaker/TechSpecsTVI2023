...
\titlespacing*{\part}{-10pt}{0pt}{10pt}
...
\listoffigures
\extramarks{Vision Department Technology Needs}{List of Tables}
\listoftables
\newpage{}
\fancyhead{}
\fancyfoot{}
...
\pagebreak\begin{longtable}[]{>{\raggedright\arraybackslash}b{.25\textwidth}>{\raggedright\arraybackslash}m{.2\textwidth}>{\raggedright\arraybackslash}b{.15\textwidth}>{\raggedright\arraybackslash}m{.1\textwidth}>{\raggedright\arraybackslash}b{.1\textwidth}>{\raggedright\arraybackslash}b{.15\textwidth}}
	\toprule
...
\hspace{-1cm} \pagebreak\begin{longtable}[]{@{}
...
\pagebreak\begin{longtable}[]{@{}
	...
	Seika Studio\footnote{\raggedright This is a Windows Computer without a monitor, substituting a 40 cell braille display} & \$6,500                                                                                                                                         & QWERTY                 & 8GB-16GB     & none                 & 12th Gen i7        \\ [1.0em]\hline
...
Notability                                 & free\footnote{\raggedright with in app purchases}                                                          & Scan \& Markup Documents                                       & iOS/iPadOS \break AndroidOS 13+ \\[1.0em]
	\multicolumn{4}{l}{\textbf{Ptical Character Recognition}}                                                                                                                                                                 \\[1em]
...
b.note                                                                                                                                                                                                                                                       & \$4,360                                                                                                                   & 15h              & Perkins           & Eurobraille           & Proprietary                                                                                                                                                                                                                                                                                                                                                                                       \\[1.0em]\hline
...
The pioneering companies Thinkerbell Labs in India and OHFA Tech in South Korea, have independently suggested that the low braille literacy rates world wide can be mitigated by providing braille instruction using this type of approach\footnote{\raggedright \href{http://www.thinkerbelllabs.com/static/decks/tl_deck.pdf}{PDF Slide Deck}}. Both groups have also demonstrated that the use of their products reduces the time to learn braille by upwards of 50\%\footnote{\raggedright \href{http://www.taptilo.com/}{Taptilo}}. Their reasoning is that the current, more traditional system of braille instruction requires:
\begin{itemize}
...
BrailleBlox                                               & \$85 \footnote{\raggedright Req LeapFrog Fridge Phonics base, \textasciitilde\$20} & BrailleBot                  \\[1.0em]
...
\pagebreak \pagebreak\begin{longtable}[]{@{}
	...
	\endfoot	\endlastfoot
APH PageBlaster\break (old Model Index-D V4)                                                                                                    & \$4,295\footnote{\raggedright Req free \href{http://www.aph.org/app/uploads/2020/07/Firebird_signed_V31.zip}{Firebird Tactile Graphics} Software for graphics functionality} & Simple Graphics, Interpoint Braille  & APH\break Index Braille \\[1.0em]
Basic-D V5                                                                                                                                      & \$3,695\footnote{\raggedright Req \href{http://tactileview.com/}{TactileView} license for full graphics functionality (\$\$484 for 1 year license)}                          & Simple Graphics, Interpoint Braille  & Index Braille           \\[1.0em]
BrailleTrac 120                                                                                                                                 & \$3,595                                                                                                                                                          & Simple Graphics, Interpoint Braille  & Irie-AT                 \\[1.0em]
Juliet 120                                                                                                                                      & \$4,195\footnote{\raggedright Req free \href{http://www.aph.org/app/uploads/2020/07/Firebird_signed_V31.zip}{Firebird Tactile Graphics} Software for graphics functionality} & Simple Graphics, Interpoint Braille  & ETS\break Humanware     \\[1.0em]
ViewPlus Columbia                                                                                                                               & \$3,495                                                                                                                                                          & Complex Graphics, Interpoint Braille & ViewPlus                \\[1.0em]
ViewPlus Rogue\break (used to be Max)\footnote{\raggedright I am only focusing on 11x11.5'' braille paper size as US Letter size is impractical for braille} & \$5,995                                                                                                                                                          & Complex Graphics, Interpoint Braille & ViewPlus                \\[1.0em]\hline
...
\addstarredchapter{\raggedright APPENDICES\hfill\\}
\titleformat{\chapter}[block]
{\normalfont\LARGE\bfseries\raggedright}{Appendix \thechapter\newline}{1em}{}
\titlespacing*{\chapter}{-10pt}{0pt}{0pt}
\cleardoublepage\hypertarget{troubleshooting}{}\chapter[\raggedright Troubleshooting Screenreader \& Magnifier Performance\hfill\\]{Troubleshooting Screenreader \& Magnifier Performance}\label{troubleshooting}
\minitoc \newpage

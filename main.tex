...
% TOC Formatting
% Add these commands to your preamble (after \usepackage{hyperref})
% RECOMMENDED: titletoc works better with tagpdf for accessible PDFs

% Load titletoc package for advanced TOC formatting
\usepackage{titletoc}

% Custom TOC formatting for parts
\titlecontents{part}%
[0pt]% left margin
{\addvspace{2ex}\large\bfseries}% above code
{\contentslabel[\thecontentslabel]{5em}}% numbered entry format
{\hspace*{5em}}% numberless entry format
{\hfill\contentspage}% filler and page format
[\addvspace{.5ex}]% below code

% Custom TOC formatting for chapters
\titlecontents{chapter}%
[0pt]% left margin
{\addvspace{1ex}\normalsize}% above code
{\contentslabel[\thecontentslabel]{5em}}% numbered entry format
{\hspace*{5em}}% numberless entry format
{\hspace{5em}\titlerule*[.5pc]{.}\contentspage}% filler and page format
[\addvspace{.2ex}]% below code

% Custom TOC formatting for sections
\titlecontents{section}%
[5em]% left margin (indent from chapter level)
{\normalsize}% above code
{\contentslabel[\thecontentslabel]{5em}}% numbered entry format
{\hspace*{5em}}% numberless entry format
{\hspace{5em}\titlerule*[.5pc]{.}\contentspage}% filler and page format

% Custom TOC formatting for subsections
\titlecontents{subsection}%
[10em]% left margin (indent from section level)
{\normalsize}% above code
{\contentslabel[\thecontentslabel]{5em}}% numbered entry format
{\hspace*{5em}}% numberless entry format
{\hspace{5em}\titlerule*[.5pc]{.}\contentspage}% filler and page format

% Ensure TOC gets proper accessibility tags

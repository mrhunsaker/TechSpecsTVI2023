...
\pagebreak\begin{longtable}[]{>{\raggedright\arraybackslash}b{.25\textwidth}>{\raggedright\arraybackslash}m{.2\textwidth}>{\raggedright\arraybackslash}b{.15\textwidth}>{\raggedright\arraybackslash}m{.1\textwidth}>{\raggedright\arraybackslash}b{.1\textwidth}>{\raggedright\arraybackslash}b{.15\textwidth}}
	...
	Visual Studio Code                                                                                                                                                                                                                                                                                                                    & Coding\footnote{Visual Studio Code is accessible with all screenreaders}                                                                                                                                                                      & \$0                                                                                                                                                                                                                                                                       & 4GB              & \textgreater8GB   & \textgreater11th Gen i7+ \\[1.0em]
...
\pagebreak\begin{longtable}[]{>{\raggedright\arraybackslash}b{.27\textwidth
}>{\raggedright\arraybackslash}b{.22\textwidth}
>{\raggedright\arraybackslash}b{.1\textwidth}
>{\raggedright\arraybackslash}b{.05\textwidth}
>{\raggedright\arraybackslash}b{.1\textwidth}
...
\multicolumn{4}{c}{\textbf{\large Independent Living\normalfont}}  \\[1.0em]
 	VoiceVista                             & free                                                      & Identification of surroundings                        & iOS \\[1.0em]
  	...
  	Oko                             & free                                                   & Smart Camera\break Traffic lights/traffic                                  & iOS/iPadOS\break AndroidOS 13+  \\[1.0em]
   	...
   	Seeing Eye GPS                             & free\footnote{Monthly subscription \$6}                                                      & Turn by Turn Navigation                                    & iOS/iPadOS\break AndroidOS 13+  \\[1.0em]
    	\multicolumn{4}{c}{\textbf{\large Independent Living Skills\normalfont}}                                                                                                                                                          \\[1em]

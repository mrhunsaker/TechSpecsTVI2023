...
%\dottedcontents{chapter}[2.5em]{}{1.3em}{.6em}
...
\begin{longtable}[]{>{\raggedright\arraybackslash}m{.25\textwidth}>{\raggedright\arraybackslash}m{.2\textwidth}>{\raggedright\arraybackslash}m{.1\textwidth}>{\raggedright\arraybackslash}m{.1\textwidth}>{\raggedright\arraybackslash}m{.15\textwidth}>{\raggedright\arraybackslash}b{.15\textwidth}}
	...
	\endlastfoot                                                                                            
	JAWS                                                                                                                                                                                                                                                                                                                                  & Screenreader                                                                                                                                                                                                                         & \$95/yr\footnote{typically purchased via through APH quota funds}  & 8GB              & \textgreater16GB                                                                                                                                           & \textgreater11th Gen i5+ \\[2.5em]
...
\begin{longtable}[]{@{}
	...
	\textbf{Students \& Professionals} \break Dell Latitude 3190 Education & \$379         & 42W                                              & QWERTY            & 4GB\footnote{student laptops have 4GB}\break 8GB\footnote{\emph{some} professional laptops have 4GB, the majority have 8GB}
	                                                                       & 11.6''        & Intel Celeron Silver\break (Intel for Education)                                                                                                                                                                                               \\[2.5em]
	\textbf{Professionals} \break Dell Precision 3530                      & \$1751        & 195W                                             & QWERTY            & 16GB                                                                                                                        & 16.0''               & 8th Gen i7         \\[2.5em]
	\textbf{Professionals} \break Dell Precision 7420                      & \$2,349       & 195W                                             & QWERTY            & 16GB                                                                                                                        & 16.0''               & 8th Gen i7         \\[2.5em]
	\textbf{My Personal Laptop} \break Microsoft Surface Laptop 3          & \$2500        & QWERTY                                           & 32GB              & 32GB                                                                                                                        & 15.0''               & AMD Ryzen 7        \\ [2.5em] \hline
...
\pagebreak	\phantomsection\subsection{Laptop Cost Optimization}\label{optimizing-cost-with-performance}}
...
\hspace{-1cm} \begin{longtable}[]{@{}
	...
	\textbf{8GB} \break \$1184\footnote{Dell Latitude 3190 Education}                                                                                                                      & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & $\checkmark$ & \$11,840            \\[2.5em]
	\textbf{16GB} \break \$1751\footnote{Dell Precision 3530 given to TVIs teaching screenreaders}                                                                                         & $\checkmark$ & --           & $\checkmark$ & --           & $\checkmark$ & --           & $\checkmark$ & --           & $\checkmark$ & --           & \$8,755             \\[2.5em]
	\hdashline[0.5pt/5pt]                                                                                                                                                                                                                                                                                                                                              \\
	\textbf{32GB}\break \$2824\footnote{Microsoft Surface Laptop 3}\break \textcolor{red}{Best Case}\footnote{This is my personal experience}                                              & $\checkmark$ & --           & --           & --           & --           & $\checkmark$ & --           & --           & --           & --           & \$5,648             \\[2.5em] \\

	\textbf{32GB}\break \$2824\footnote{Microsoft Surface Laptop 3}\break \textcolor{red}{Cautious}\footnote{This is a conservative estimate to account for potential rough treatment of a computer}                                                                                        & $\checkmark$ & --           & --           & $\checkmark$ & --           & --           & $\checkmark$ & --           & --           & --           & \$8,472             \\[2.5em] \hline
...
Notability &free\footnote{with in app puchases} & Scan \& Markup Documents & iOS/iPadOS \break AndroidOS 13+\\[2.5em]
GoodNotes  &free\footnote{with in app puchases}  & Scan \& Markup Documents & iOS/iPadOS \break AndroidOS 13+\\[2.5em]
My Board Buddy  & free & all the things  & iOS/iPadOS\\[2.5em]
Desmos Graphing Calculator & free & all the things  & iOS/iPadOS \break AndroidOS 13+\\[2.5em]
Desmos Scientific Calculator & free & all the things  & iOS/iPadOS \break AndroidOS 13+\\[2.5em]
\multicolumn{4}{c}{\textbf{Optical Character Recognition}}\\[1em]
KNFB Reader\break(rebranded OneStepReader) & \$99.99   & OCR/Reading & iOS/iPadOS\break AndroidOS 13+ \\[2.5em]
SeeingAI & free & talking camera\break OCR & iOS/iPadOS\break AndroidOS 13+ \\[2.5em]
TapTapSee & free & talking camera\break OCR & iOS/iPadOS\break AndroidOS 13+ \\[2.5em]
\multicolumn{4}{c}{\textbf{Orientation \& Mobility / Navigation}} \\[1em]
HapticNav         & free\footnote{requires in app puchases} & Haptic turn by turn GPS navigation  & iOS/iPadOS\break AndroidOS 13+      \\[2.5em]
BlindSquare       & \$39.99                 &       & iOS/iPadOS     \\[2.5em]
XploreNinja       & \$39.99  & MIPSoft & AndroidOS 13+\\[2.5em]
WeWalk            & free\footnote{requires in app puchases} &        & iOS/iPadOS     \\[2.5em]
Google Maps       & free                    &  Turn by Turn GPS Navigation    & iOS/iPadOS\break AndroidOS 13+     \\[2.5em]
Apple Maps        & free                    &  Turn by Turn GPS Navigation       & iOS/iPadOS       \\[2.5em]
Moovit            & free\footnote{requires in app puchases} &  Local Public Transit      & iOS/iPadOS\break AndroidOS 13+      \\[2.5em]
Waymap            & free                    &  Turn by Turn GPS Navigation\break Focuses on indoor navigation    & iOS/iPadOS\break AndroidOS 13+       \\[2.5em]
Seeing Eye GPS    & free\footnote{requires in app puchases} & Turn by Turn GPS Navigation   & iOS/iPadOS\break AndroidOS 13+      \\[2.5em]\hline
...
\begin{longtable}[]{@{}
	...
	BrailleNote Touch+\footnote{For both the BrailleNote Touch+ and BrailleSense 6, there is an emerging issue with outdated operating systems, WiFi connectivity inconsistencies, and incompatibility with Google applications. \begin{itemize}[leftmargin=2em]
		                                                                                                                                                                                                                             ...
		                                                                                                                                                                                                                             \end{itemize}} & \$5,795                                                                                                                   & 12h              & Perkins           & Humanware             & Android 8\footnote{Android 8 `Oreo' Security Support Ended (\emph{i.e.}, End of Life) 2017-12-05}                                                                                                                                                                                                                                                                                            \\[2.5em]
	BrailleSense 6                                                                                                                                                                                                                               & \$5,795                                                                                                                   & 12h              & Perkins           & HIMS                  & Android 10\footnote{Android 10 `Queen Cake' Security Support Ended (\emph{i.e.}, End of Life) 2023-03-06}\footnote{The Braillesense has a firmware update v2.0 released 2023-11-28 which updates the operating system to Android 12, but this is currently buggy and causing system overheating. (\emph{note:} Android 12 will only receive updates until \textasciitilde October of 2024)} \\[2.5em]
	InsideONE                                                                                                                                                                                                                                    & \$5,499                                                                                                                   & 6h               & Perkins           & InsideVision          & Windows 11                                                                                                                                                                                                                                                                                                                                                                                  \\[2.5em]
	Nattiq Note                                                                                                                                                                                                                                  & \$5,200                                                                                                                   & 12h              & QWERTY            & Nattiq                & Windows 11                                                                                                                                                                                                                                                                                                                                                                                  \\[2.5em]
	Notey the Notetaker                                                                                                                                                                                                                          & \textasciitilde\$750+\footnote{Self build
	\href{https://notey-project.com/2023/03/07/notey-user-manual-v1-0-2/}{Specs for Notey the NoteTaker}}                                                                                                                                        &                                                                                                                           & QWERTY Perkins   & Miscs             & Windows 11                                                                                                                                                                                                                                                                                                                                                                                                          \\[2.5em]
...
\begin{flushleft} \begin{longtable}[]{@{}
		...
		\endfoot	\endlastfoot
		Brailliant BI20x                                                                                             & \$2,199       & 14               & Perkins           & Humanware             \\[2.5em]
		Focus 14 Blue                                                                                                & \$1,545       & 18               & Perkins           & Vispero               \\[2.5em]
		Chameleon 20                                                                                                 & \$1,715       & 14               & Perkins           & APH                   \\[2.5em]
		Orbit Reader 20+                                                                                             & \$799         & 20               & Perkins           & Orbit Research        \\[2.5em]
		Orbit Speak\footnote{This device has no braille output, but uses braille input and returns aauditory output} & TBD           & 20               & Perkins           & Orbit Research        \\[2.5em]
		Actilino                                                                                                     & \$2,795       & 16               & Perkins           & Help Tech             \\[2.5em]
		Basic Braille 20                                                                                             & \$2,295       & 16               & none              & Help Tech             \\[2.5em]
...
\begin{longtable}[]{@{}
	...
	\endlastfoot
	Brailliant BI40x   & \$3,195       & 14               & Perkins           & Humanware             \\[2.5em]
	Focus 40 Blue      & \$3,145       & 18               & Perkins           & Vispero               \\[2.5em]
	Mantis Q40         & \$2,495       & 14               & QWERTY            & APH                   \\[2.5em]
	Orbit Reader 40    & \$1,399       & 20               & Perkins           & Orbit Research        \\[2.5em]
	QBraille XL        & \$3,195       & 16               & Perkins           & HIMS                  \\[2.5em]
	Basic Braille Plus & \$3,295       & 12               & Perkins           & Help Tech             \\[2.5em]
	Active Star        & \$6,795       & 40               & Perkins           & Help Tech             \\[2.5em]
	Active Braille     & \$6,495       & 20               & Perkins           & Help Tech             \\[2.5em]
	Activator          & \$6,495       & 40               & Perkins           & Help Tech             \\[2.5em]
	Vario Ultra 40     & \$7,643       & 12               & Perkins           & VisioBraille          \\[2.5em]
	Vario 340          & \$5,138       & 20               & none              & VisioBraille          \\[2.5em]
	Vario 440          & \$4,550       & 20               & none              & VisioBraille          \\[2.5em]
	Seika V5           & \$2,495       & 20               & none              & Nippon Telesoft       \\[2.5em]
...
\begin{longtable}[]{@{}
	...
	\endfoot	\endlastfoot
	ViewPlus Rogue\break (used to be Max)\footnote{I am only focusing on 11x11.5'' braille paper size as US Letter size is impractical for braille} & \$5,995                                                                                                                                                          & Complex Graphics, Interpoint Braille & ViewPlus                \\[2.5em]
	ViewPlus Columbia                                                                                                                               & \$3,495                                                                                                                                                          & Complex Graphics, Interpoint Braille & ViewPlus                \\[2.5em]
	APH PageBlaster\break (old Model Index-D V4)                                                                                                    & \$4,295\footnote{Req free \href{https://www.aph.org/app/uploads/2020/07/Firebird_signed_V31.zip}{Firebird Tactile Graphics} Software for graphics functionality} & Simple Graphics, Interpoint Braille  & APH\break Index Braille \\[2.5em]
	Basic-D V5                                                                                                                                      & \$3,695\footnote{Req \href{https://tactileview.com/}{TactileView} license for full graphics functionality (\$\$484 for 1 year license)}                          & Simple Graphics, Interpoint Braille  & Index Braille           \\[2.5em]
	Juliet 120                                                                                                                                      & \$4,195\footnote{Req free \href{https://www.aph.org/app/uploads/2020/07/Firebird_signed_V31.zip}{Firebird Tactile Graphics} Software for graphics functionality} & Simple Graphics, Interpoint Braille  & ETS\break Humanware     \\[2.5em]
	BrailleTrac 120                                                                                                                                 & \$3,595                                                                                                                                                          & Simple Graphics, Interpoint Braille  & Irie-AT                 \\[2.5em]\hline
...
\begin{longtable}[]{@{}
	...
	\multicolumn{3}{r}{\textbf{Continued on Next Page}} \endfoot
	\endlastfoot
	PIAF tactile embosser                               & \$1,745                                                                                                                                                                                & Humanware           \\[2.5em]
	Swell Form Machine                                  & \$1,400.00                                                                                                                                                                             & American Thermoform \\[2.5em]
	EZ-Form Brailon Duplicator                          & \$3,899                                                                                                                                                                                & American thermoform \\[2.5em]
	ViewPlus Rogue \break (used to be ViewPlus Max)     & \$5,995\footnote{Req \href{https://viewplus.com/product/tiger-software-suite8/}{Tiger Software Suite} for full functionality (\$195 for 1 year license; \$595 for perpetual license)}  & ViewPlus            \\[2.5em]
	ViewPlus Columbia                                   & \$3,495\footnote{Req \href{https://viewplus.com/product/tiger-software-suite8/}{Tiger Software Suite} for full functionality (\$195 for 1 year license; \$595 for perpetual license)}  & ViewPlus            \\[2.5em]
	APH PixBlaster \break (old Model ViewPlus Columbia) & \$4,295\footnote{Req \href{https://viewplus.com/product/tiger-software-suite8/}{Tiger Software Suite} for full functionality (\$195 for 1 year license; \$595 for perpetual license)}  & APH\break ViewPlus  \\[2.5em]
	ViewPlus Delta                                      & \$4,195\footnote{Req \href{https://viewplus.com/product/tiger-software-suite8/}{Tiger Software Suite} for full functionality (\$195 for 1 year license; \$595 for perpetual license)}  & ViewPlus            \\[2.5em]
...
\begin{longtable}[]{@{}
	...
	\multicolumn{5}{r}{\textbf{Continued on Next Page}} \endfoot
	\endlastfoot
	Neptune 4 Pro   & \$330         & 225x225x265mm           & 1.75mm                 & Elegoo                \\[2.5em]
	Neptune 3 Max   & \$470         & 420x420x500mm           & 1.75mm                 & Elegoo                \\[2.5em]
	M5C             & \$399         & 220x220x250mm           & 1.75mm                 & AnkerMake             \\[2.5em]
	Kobra Plus      & \$499         & 300x300x350mm           & 1.75mm                 & Anycubic              \\[2.5em]
	Kobra Max       & \$569         & 450x400x400mm           & 1.75mm                 & Anycubic              \\[2.5em]
	Ender 3 Max Neo & \$359         & 300x300x320mm           & 1.75mm                 & Creality              \\[2.5em]
	Ender 5 Plus    & \$579         & 350x350x400mm           & 1.75mm                 & Creality              \\[2.5em]
	Mini+           & \$459         & 180x180x180mm           & 1.75mm                 & Prusa                 \\[2.5em]
	Sidewinder X2   & \$399         & 300x300x396mm           & 1.75mm                 & Artillery             \\[2.5em]
	P1P 3D Printer  & \$699         & 256×256×256mm           & 1.75mm                 & Bambu                 \\[2.5em]
	P1S 3D Printer  & \$949         & 256×256×256mm           & 1.75mm                 & Bambu                 \\[2.5em]\hline
	\caption{ 3D Printers }
\end{longtable}

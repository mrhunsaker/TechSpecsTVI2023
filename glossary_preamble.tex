% Expanded Professional Glossary definitions for TechSpecsTVI project
...
\newglossaryentry{AI}{
	name={AI},
	description={Artificial Intelligence - computer systems that perform tasks typically requiring human intelligence, such as visual recognition, speech processing, and decision-making. In accessibility, AI powers features like image description, predictive text, voice recognition, and automated captioning}
}
...
\newglossaryentry{ML}{
	name={ML},
	description={Machine Learning - a field of AI that uses statistical techniques to give computer systems the ability to "learn" from data without being explicitly programmed. In assistive technology, ML improves speech recognition, predictive text, and personalization features}
}
...
\newglossaryentry{OCR}{
	name={OCR},
	description={Optical Character Recognition - technology that converts images of text (such as scanned documents or photographs) into machine-readable text that can be accessed by screen readers and other assistive technologies}
}
...
\newglossaryentry{OM}{
	name={O\&M},
	description={Orientation and Mobility - specialized instruction that teaches people with visual impairments safe and independent travel skills. Includes cane techniques, environmental awareness, route planning, and use of transportation systems}
}
...
\newglossaryentry{orientationmobility}{
	...
	description={Specialized instruction that teaches people with visual impairments to travel safely and independently. Includes techniques for using white canes, understanding traffic patterns, navigating with technology, and developing spatial awareness skills}
}
...
\newglossaryentry{processor}{
	name={processor},
	description={The central processing unit (CPU) of a computer that executes instructions and calculations. Processing power affects the performance of assistive technology, particularly complex applications like screen readers with advanced speech synthesis}
}
...
\newglossaryentry{refreshablebrailledisplay}{
	...
	description={Electronic devices with tactile braille cells that use piezoelectric technology to raise and lower pins, forming braille characters. Connects to computers and mobile devices to provide tactile access to digital text}
}
...
\newglossaryentry{RTD}{
	name={RTD},
	description={Refreshable Tactile Display - electromechanical devices for displaying tactile information, usually by means of raising and lowering pins to create braille characters or simple graphics}
}
...
\newglossaryentry{texttospeech}{
	name={text-to-speech},
	description={Technology that converts written text into spoken audio output using synthetic speech. Core functionality of screen readers and reading support software, with adjustable speech rate, pitch, and voice selection options}
}

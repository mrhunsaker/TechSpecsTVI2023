...
Object communication systems use tangible objects to represent activities, people, or places. For example, a spoon might represent "time to eat." This is a concrete way to introduce symbolic communication and is often a bridge to more abstract systems like tactile symbols or \gidx{braille}{braille}.
...
\begin{itemize}
	...
	\item \textbf{Closing The Gap, Inc.:} Hosts an annual conference and provides resources on \gidx{assistivetechnology}{assistive technology}, including AAC.
...
The NRTC conducts research and provides training on a wide range of topics related to blindness and low vision. The center's work focuses on improving employment outcomes, independent living, and quality of life for individuals with visual impairments\index{visual impairment}. The NRTC offers online courses, publications, and other resources that are relevant to communication and \gidx{assistivetechnology}{assistive technology}.
...
\begin{itemize}
	...
	\item \textbf{Jane Farrall:} An independent consultant and trainer who provides resources and workshops on literacy, AAC, and \gidx{assistivetechnology}{assistive technology}, including switch access.
...
The advent of 3D printing\index{3D printing} has opened up new possibilities for creating customized, low-cost tactile communication tools. Several projects and organizations are making 3D printable models and \gidx{tactilegraphics}{tactile graphics} widely available.
...
\begin{itemize}
	...
	\item \textbf{APH\gidx{brailleembosser}{braille embosser}\index{braille embosser!APH} TactileBliss Symbols:} The American Printing House for the Blind offers a set of durable, thermoformed tactile Blissymbols.
...
\subsection{\gidx{tactilegraphics}{Tactile Graphics} Creation Tools and Services}\label{app6:tactile-graphics}
\begin{itemize}
	...
	\item \textbf{Swell Papertactile graphics\index{tactile graphics!swell paper}:} A type of microcapsule papertactile graphics\index{tactile graphics!capsule paper} that allows users to create raised-line graphics by printing with a standard inkjet or laser printer and then heating the paper in a specialized oven.

...
\begin{figure}[htbp]
	\centering
	\imgalt{Historical trends in primary desktop/laptop screen reader usage (JAWS, NVDA, VoiceOver, Narrator).}{\includegraphics[width=0.8\linewidth]{SR-2.png}}
...
\begin{figure}[htbp]
	\centering
	\imgalt{Historical trends in overall screen reader usage (JAWS, NVDA, VoiceOver, Narrator) from 2009 to 2024.}{\includegraphics[width=0.8\linewidth]{SR-1}}
...
\begin{longtblr}[
	...
	Other   & 30     & 1.9\%   \\
\end{longtblr}
\imgalt{Historical trends in browser usage showing increase in Edge and Chrome over time and drop of Internet Explorer. Firefox, and Safari.}{\includegraphics[width=0.8\linewidth]{browsers}}
...
\begin{figure}[htbp]
	\centering
	\imgalt{Historical mobile platform usage showing iOS dominance and Android growth over time.}{\includegraphics[width=0.8\linewidth]{mobile2}}
